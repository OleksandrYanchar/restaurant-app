...
class Menu(models.Model):
    ...
    day = models.CharField(_("day"), max_length=9, choices=DAYS_OF_WEEK, blank=False, null=False)
...
class MenuItem(models.Model):
    ...
    price = models.DecimalField(_("price"), max_digits=6, decimal_places=2, blank=False, null=False)
    picture = models.ImageField(_("picture"), upload_to='menu_pictures/', blank=True, null=True)
